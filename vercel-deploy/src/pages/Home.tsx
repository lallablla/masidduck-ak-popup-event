...
const DEFAULT_SETTINGS = {
  ...
  mainEventBenefit: "둘이 먹다 하나가 없어져도 모를 약과 2개 현장 증정!",
  mainEventTitle: "인스타 인증하고\n약과 2개 받아가세요!",
  mainEventDescription:
    "마시떡 인스타그램을 팔로우하고\n팝업 현장 사진 또는 피자설기 사진을 올려주세요.\n참여 완료 화면을 직원에게 보여주시면 약과 2개를 드립니다.",
          ...
          <Card className="border-primary/10 shadow-sm overflow-hidden bg-card">
            <CardContent className="p-5">
              ...
              {settings.highlightMessage && (
                <div className="mt-4 p-3 bg-primary/5 rounded-xl text-primary text-sm font-semibold text-center break-keep leading-relaxed whitespace-pre-line">
                  {settings.highlightMessage}
                </div>
              )}
            </CardContent>
